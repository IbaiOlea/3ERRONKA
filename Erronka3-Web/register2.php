    ...
    <div class="login-container">
        <div class="texto">
            ...
            <form action="" method="POST">
                ...
                <input type="text" name="data" placeholder=" Jaioturtea: XX/XX/XXXX" required>
                <input type="text" name="sexua" placeholder="G edo M" required>
                <input type="text" name="alt" placeholder="Altuera (cm)" required>
                <input type="text" name="pisua" placeholder="Pisua (kg)" required>
                <button type="submit">Datuak Sartu</button>
            </form>
        </div>
    </div>
